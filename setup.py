...
setup(name=PACKAGENAME,
      ...
      packages=['zuds', 'zuds.baselayer',
                'zuds.baselayer.app',
                'zuds.baselayer.app.handlers',
                'zuds.skyportal', 'zuds.skyportal.tests',
                'zuds.skyportal.tests.tools',
                'zuds.skyportal.tests.frontend',
                'zuds.skyportal.utils',
                'zuds.skyportal.handlers',
                'zuds.skyportal.handlers.api',
                'zuds.skyportal.handlers.api.internal'],
      package_dir={'zuds': 'zuds',
                   'zuds.skyportal': 'zuds/skyportal/skyportal',
                   'zuds.baselayer': 'zuds/skyportal/baselayer'},
      author=AUTHOR,
